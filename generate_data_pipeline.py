...
def draw_step_bg(x, y, w, h, title, color):
    ...
    ax.add_patch(rect)
    ax.text(x, y + h/2 - 2, title, fontsize=15, fontweight='bold', color=color, ha='center', va='top', zorder=1)
...
# 连接 增强 <-> 校对 (双向迭代循环)
draw_arrow((62, 37), (62, 26)) # 增强下发到校对
draw_arrow((38, 26), (38, 37)) # 校对打回给清洗
ax.text(64, 31, "审核", fontsize=11, color="#666666")
ax.text(34, 31, "重构", fontsize=11, color="#666666")
