...
def draw_arrow(start, end, text="", color="#555555", lw=2.5, text_offset=(0,0)):
...
# Tokenizer -> Embedding
draw_arrow(right_t, left_e, text="传入 Token IDs", text_offset=(0, 0))

# Embedding (去噪后) -> 输出
draw_arrow((MID_X2 + 8, 42), out_left, text="抽取特征", text_offset=(-6, -3))
draw_arrow((MID_X2 + 8, 30), out_left, text="高维投影", color="#448C55", text_offset=(0, -2))
