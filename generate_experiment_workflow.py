...
# 3 -> 4 (Yes: 需要微调，走左边)
draw_arrow(dec_left, ft_top, text="是 (Yes)\n偏见超标，进入微调", rad=-0.2, color="#A84144", text_offset=(-4, 3))

# 3 -> 5 (No: 偏见达标，直接走下面评估)
draw_arrow(dec_bot, eval_top, text="否 (No)\n偏见在安全域内", color="#448C55", text_offset=(0, 0))
...
draw_arrow(dec_left, out_right, text="完成迭代", color="#2B7B8C", text_offset=(0, 0))
